...
def download_single_image(id_urls):
        id = id_urls[0]
        for image_url in id_urls[1]:
            index = uuid.uuid4()
            ...
            current_image_batch.append( os.path.join('digi_image_crawled', name))


def _prodouct2images(product_ids, headers, cookies, match_func, sleep_time, ocr_url, num_workers):
    import time
    all_urls = []
